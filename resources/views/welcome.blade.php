        ...
        <div class=" block justify-center">
            ...
            @endif
                ...
                <div class="block justify-center flex items-center">
                    <svg class="block" version="1.1" xmlns="http://www.w3.org/2000/svg" width="25.25mm" height="25.25mm" viewBox="-1375 -875 6550 5125">
                     ...
                     <h2 class="block text-gray-600 text-indigo-600	justify-center flex items-center">samsara</h2>
                    ...
                    <div class="flex-auto mt-8 bg-white dark:bg-gray-500  sm:rounded-md justify-center flex items-center">
                        <div class="flex-auto p-6 border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l justify-center">
                            ...
                            <h4>"There is a wonderful net 
                                ...
                                If we look closely at it, we will discover that they reflect all the other jewels in</br> the net, infinite in number. 
                                Not only that, but each of the jewels reflected in this one jewel is also reflecting all the other jewels, so that there is an infinite reflecting process occurring."</br>
                                ...
                                <div class=" block mt-2 text-purple-900 dark:text-gray-400 text-md justify:center">
                                    <img src="{{ asset('images/holding-hands.jpg')}}" width="180" height="180px"></br></br>
                                           ...
                                           &nbsp&nbsp&nbspShare and Support</br></br>
                                            <div class="block dark:bg-gray-500  sm:rounded-md  grid-cols-3 gap-1 place-items-center h-40 grid-flow-col justify:center">
