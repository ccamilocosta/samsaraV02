            ...
            <div class=" max-w-6xl mx-auto sm:px-8 lg:px-6">
                ...
                <div class="mt-8 bg-white dark:bg-gray-500  sm:rounded-md">
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            ...
                            <h2 class="block font-semibold font-sans text-purple-900 justify-center -mx-8">Indras Net</h2> 
                            <div class=" block mt-2 text-gray-600 dark:text-gray-400 text-md justify-center -mx-8">
                             ...
                             We are interconnected here to (((reflect))) ourselves through our stories.</br> 

                              </div>
                              <!-- <h ref="{{ route('acceptRequest',[$newRequest ?? ''])}}"><strong>Please sign up</strong> </href> 
                             -->
                             <h ref="route('register')" :active="request()->routeIs('register')"><strong>Please sign up</strong> </href>
                        </div>
                                     ...
                                     <div class="p-6 border-t border-gray-200 dark:border-gray-700 ">
                                         <div class="flex items-center">
                                            ...
                                            <div class="dark:bg-gray-500  sm:rounded-md block ml-4 text-lg leading-7 font-semibold"><a href="" class=" text-gray-900 dark:text-white">About Us</a>
