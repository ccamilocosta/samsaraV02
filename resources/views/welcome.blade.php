    ...
    <body class="antialiased">
        ...
        <div class=" block justify-center ">
            ...
            @endif
                ...
                <div class="block justify-center flex items-center">
                    <svg class="block" version="1.1" xmlns="http://www.w3.org/2000/svg" width="27mm" height="27mm" viewBox="-1375 -875 6550 5125">
                     ...
                     <h2 class="block text-gray-600 font-semibold text-indigo-600 justify-center flex items-center">samsara</h2>

                    <div class="flex-auto mt-8 bg-white dark:bg-gray-500  sm:rounded-md justify-center flex items-center">
                        <div class="flex-auto p-6 border-gray-300 border-2  md:border-l md:border-r justify-center">
                            <img src="{{ asset('images/indrasnet.jpg') }}" width="1540" height="500px">
                         <h4 class= " block flex items-center justify-center">There is a wonderful net 
                                that stretches out infinitely in all directions. 
                                There hang the jewels, glittering "like" stars in the first magnitude. 
                                If we look closely at it, we will discover that they reflect all the other</br>  
                                jewels in the net, infinite in number. 
                                Not only that, but each of the jewels reflected in this one jewel is also reflecting all the other
                                jewels, so that there is an infinite reflecting process occurring."</br>
                                We are interconnected here to (((reflect))) ourselves through our stories.</br>Please sign up</h4></br> 
                                ...
                                <div class="p-6 border-t border-gray-300 dark:border-gray-700">
                                    <div class="flex items-center ">
                                        ...
                                        <div class="dark:bg-gray-500  sm:rounded-md block ml-4 text-lg leading-7 font-semibold flex items-center"><p class="ml-4 text-lg leading-7 font-semibold" >About Us</p>

                                    </div>
                                </div> 
                            
                                <div class=" inline-block mt-2 text-purple-900 dark:text-gray-400 text-md justify:center">
                                    <img src="{{ asset('images/holding-hands.jpg')}}" width="180" height="180px"></br></br>
                                            Samsara is community driven</br>
                                           &nbsp&nbsp&nbspShare and Support</br></br>
                                            <div class="inline-block dark:bg-gray-500  sm:rounded-md  grid-cols-3 gap-1 place-items-center h-40 grid-flow-col justify:center">
                                                <a href= "https://www.instagram.com/samsara.blog/"><img src="{{ asset('images/instagramlogo.jpg') }}" width="60px" height="60px" ></a>
                                                <a href=""><img src="{{ asset('images/facebooklogo.jpg') }}" width="60px" height="60px"></a>
                                                <a href="https://twitter.com/samsara_blog"> <img src="{{ asset('images/twitterlogo.jpg') }}" width="60px" height="60px"></a>
                                            </div> 
                                </div> 
