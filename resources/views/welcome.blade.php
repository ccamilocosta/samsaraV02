                    ...
                    <div class="flex-auto mt-8 bg-white dark:bg-gray-500  sm:rounded-md justify-center">
                        <div class="flex-auto p-6 border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l justify-center">
                            ...
                            <h4>"There is a wonderful net 
                                ...
                                If we look closely at it, we will discover that they reflect all the other jewels in the net, infinite in number. 
                                ...
                                <div class="p-6 border-t border-gray-200 dark:border-gray-700 ">
                                    <div class="flex items-center">
                                        ...
                                        <div class="dark:bg-gray-500  sm:rounded-md block ml-4 text-lg leading-7 font-semibold"><p class="ml-4 text-lg leading-7 font-semibold" >About Us</p>
